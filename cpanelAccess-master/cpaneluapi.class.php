...
class cpanelAPI
{
    ...
    {
        //echo("comes to this  __get  function <br>");
        //echo $name;
    ...
    {
        // echo("comes to this  setApi  function <br> ");
        $this->api = $api;
        $this->setMethod();
        return $this;
    }
    ...
    {
       // echo("comes to this  setMethod  function <br> ");
        switch ($this->api) {
            case 'uapi':
                $this->method = '/execute/';
                break;
    ...
    {
       //  echo("comes to this  __call  function <br> ");
    ...
    {
        // echo("comes to this  APIcall function <br> ");
         //echo "names".$name."<br>";
         //echo "argumements".$arguments."<br>";
    ...
    {
       // echo("comes to this  curl_request function <br> ");
        //echo $url;
    ...
    {
        // echo("comes to this  curl_exec_follow function ");
    ...
    public function getLastRequest()
    {
        return $this->requestUrl;
          //   echo("comes to this  getLastRequest function");
